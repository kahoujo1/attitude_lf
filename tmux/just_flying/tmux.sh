...
'
  'Martin1' 'waitForRos; /home/mrs/git/mrs_dcm/run/250414_two_intel_drones/2_run/mrs_dcm.sh
'
  'Martin2' 'waitForRos; /home/mrs/git/mrs_dcm/run/250414_two_intel_drones/2_run/pinger.sh
'
